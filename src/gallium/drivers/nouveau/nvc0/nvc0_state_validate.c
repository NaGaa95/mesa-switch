...
nvc0_validate_fb(struct nvc0_context *nvc0)
{
   ...
   /* A pitch-linear color target cannot be combined with a (tiled) depth
    * buffer; programming ZETA anyway faults or corrupts.  Match upstream and
    * disable ZETA for that combination.
    */
